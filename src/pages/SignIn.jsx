  ...
  return (
    ...
    <form action="">
      <div className="flex flex-col h-[30rem] max-w-lg mt-6 mx-auto bg-white border border-slate-400 rounded-lg">
        ...
        <input type="submit" className="w-[91%] p-2 rounded-md mx-auto mb-2 text-white bg-green-400 font-medium hover:bg-green-500 active:bg-green-600 shadow-md" value="Sign In"/>
        ...
        <p className="mt-4 mb-4 font-medium text-center">Don't have an account? <input className="text-blue-400 hover:text-blue-500 active:text-blue-600" type="submit" value="Sign up"/></p>
      </div>
    </form>
    </>
  );
